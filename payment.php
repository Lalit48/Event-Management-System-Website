...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO payments(full_name, email_address, phone_number, payment_date, payment_amount, payment_method, transaction_id, event_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($conn, $sql);

    // Bind parameters to the prepared statement
    mysqli_stmt_bind_param($stmt, "ssssdsss", $full_name, $email, $phone_number, $payment_date, $payment_amount, $payment_method, $transaction_id, $event_name);
            ...
            <div class="row"> 
                ...
                <div class="col"> 
                   <img src="https://i.ibb.co/wWtkkRJ/evento-logo.png" altmethod="post"="logo">
                    ...
                    <div class="inputBox">
                        <label for="event_name"><b style="font-family: 'Times New Roman', Times, serif;">Event Name</b></label>
