...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSMGdegTqWggYCaWA8izYdC82opSlvyxaYNGdOv1C27MSwsb9wt" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
        ...
        <section class="event"> 
            ...
            <h1>Corporate Retreat Package</h1> 
...
decorative 
                    ...
                    <a href="CRpayments.php" class="btn">Register</a>
                </p> 
            </div> 
