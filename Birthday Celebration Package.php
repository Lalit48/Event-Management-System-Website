...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcTfcxlVYtNv9xH659nrKDHeVDwBtIeh8qnXnRvF3cjJxeKINwu0" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
...
decorative 
                    ...
                    <a href="Bpayments.php" class="btn">Register</a>
                </p> 
            </div> 
