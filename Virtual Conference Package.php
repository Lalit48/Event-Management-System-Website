...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSRUH5SvjoEORvKWazN0Zn-i07s0GmfgtISkQRngsoRJEvynGd3" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
        ...
        <section class="event"> 
            ...
            <h1>Virtual Conference Package</h1> 
...
decorative 
                    ...
                    <a href="Vpayments.php" class="btn">Register</a>
                </p> 
            </div> 
