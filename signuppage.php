...
if(isset($_POST['register'])){
    ...
    $sql = "INSERT INTO registration(username,number,email,password) values ('$username','$number','$email','$password')";
    ...
    <div class="login-page">
      <div class="form">
        ...
        <form method="post"> 
          ...
          <p class="message">Already registered? <a href="login.php">Login</a> here</p>
        </form>
      </div>
    </div>
  </body>
