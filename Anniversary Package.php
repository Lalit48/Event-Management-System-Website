...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPCbVfckQoWtg3tie51-XVOoVWebUV-CX4FD1bJ0i0j613GA1V" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
...
decorative 
                    ...
                    <a href="Apayments.php" class="btn">Register</a>
                </p> 
            </div> 
