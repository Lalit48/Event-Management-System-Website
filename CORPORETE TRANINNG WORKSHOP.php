...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcTx6tEJHDJFnIg8T3q-qvbIAdhiVb4xJ7B-F4gPnrs8IgeDRGCq" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
        ...
        <section class="event"> 
            ...
            <h1>CORPORETE TRANINNG WORKSHOP</h1> 
...
decorative 
                    ...
                    <a href="CTpayments.php" class="btn">Register</a>
                </p> 
            </div> 
