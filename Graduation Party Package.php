...
<body>
    ...
    <h1 class="heading">
        ...
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTTeKP-VitmvZ_tw2PNYVVpc-R0H2BrRPV7KA8IyoZ_1rbGP5-m" alt="Event Image" hight="30%" width="100%"> 
    </header> 
    <main> 
        ...
        <section class="event"> 
            ...
            <h1>Graduation Party Package</h1> 
...
decorative 
                    ...
                    <a href="Gpayments.php" class="btn">Register</a>
                </p> 
            </div> 
